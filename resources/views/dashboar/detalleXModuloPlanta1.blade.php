...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('dashboar.detalleXModuloPlanta1') }}" method="GET" id="filterForm">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    document.getElementById("filterForm").addEventListener("submit", function(event) {
                        ...
                        this.action = "{{ route('dashboar.detalleXModuloPlanta1') }}?fecha_inicio=" + fechaInicioValue + "&fecha_fin=" + fechaFinValue;
                    });
                });
