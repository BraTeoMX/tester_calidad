            ...
            $('#btn-actualizar-todo').on('click', function () {
                ...
                $('#tabla-registros-hoy tbody tr').each(function () {
                    ...
                    if (accion) {
                        ...
                        /* Validación: si es parcial, debe tener una cantidad
                        if (accion === '2' && !cantidadParcial) {
                            validacionesPasadas = false;
                            mensajesErrorValidacion.push(`- El registro con OP "${op}" está marcado como Parcial pero no tiene una cantidad asignada.`);
                        } else */
