@extends('layouts.app', ['pageSlug' => 'dashboardSemanaPlanta2V2', 'titlePage' => __('Dashboard')])
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("btnMostrar").addEventListener("click", function () {
                ...
                if (!aqlLoaded) {
                    cargarDatos("{{ route('dashboardSemanaPlanta2V2.buscarAQLP2') }}", "tablaAQLGeneralNuevoBody", "datosModuloEstiloAQL");
                    aqlLoaded = true;
                }
            ...
            document.getElementById("showAQLTE").addEventListener("click", function () {
                ...
                if (!aqlteLoaded) {
                    cargarDatos("{{ route('dashboardSemanaPlanta2V2.buscarAQLTEP2') }}", "tablaAQLGeneralTENuevoBody", "datosModuloEstiloAQLTE");
                    aqlteLoaded = true;
                }
            ...
            document.getElementById("showProceso").addEventListener("click", function () {
                ...
                if (!procesoLoaded) {
                    cargarDatosProceso("{{ route('dashboardSemanaPlanta2V2.buscarProcesoP2') }}", "tablaProcesoGeneralNuevoBody", "datosModuloEstiloProceso");
                    procesoLoaded = true;
                }
            ...
            document.getElementById("showProcesoTE").addEventListener("click", function () {
                ...
                if (!procesoteLoaded) {
                    cargarDatosProceso("{{ route('dashboardSemanaPlanta2V2.buscarProcesoTEP2') }}", "tablaProcesoGeneralTENuevoBody", "datosModuloEstiloProcesoTE");
