            ...
            <table class="table" id="tabla-datos-principales">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control texto-blanco" name="team_leader" id="team_leader"
                                value="{{ $data['team_leader'] }}" readonly>
                        </td>
                        <td>
            ...
            <table class="table table32" id="tabla-datos-secundarios">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" class="form-control texto-blanco" name="pieza" id="pieza-seleccion"
                                readonly></td>
                        <td><input type="text" class="form-control texto-blanco" name="estilo" id="estilo-seleccion"
                                readonly></td>
                        <td><input type="text" class="form-control texto-blanco" name="color" id="color-seleccion"
                                readonly></td>
                        <td><input type="text" class="form-control texto-blanco" name="talla" id="talla-seleccion"
                                readonly></td>
                        ...
                        <td><input type="text" class="form-control" name="accion_correctiva" id="accion_correctiva"
                                required></td>
                        <td>
            ...
            <div id="observacion-container" data-modulo="{{ $data['modulo'] }}">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control texto-blanco" id="observacion" rows="3"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="observacion-TE" class="col-sm-6 col-form-label">Observaciones Tiempo
                            Extra:</label>
                        <div class="col-sm-12">
                            <textarea class="form-control texto-blanco" id="observacion-TE" rows="3"
                                placeholder="comentarios" required></textarea>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="nuevoConceptoModal" tabindex="-1" role="dialog" aria-labelledby="nuevoConceptoModalLabel"
    aria-hidden="true">
