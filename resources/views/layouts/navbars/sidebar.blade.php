                ...
                <div class="collapse" id="laravelExamples">
                    <ul class="nav">
                        ...
                        <li class="nav-item{{ $pageSlug == 'Etiquetas' ? ' active' : '' }}">
                            <a class="nav-link" href="{{ route('etiquetasV3.inicio') }}">
                                <i class="material-icons">edit_document</i>
                                <p>{{ __('FCC-014') }}</p>
...
<style>
    .sidebar {
        ...
        overflow: hidden;
        /* Desactiva el desbordamiento en el contenedor principal */
    }
    ...
    .sidebar-wrapper {
        ...
        scrollbar-color: #6c757d #2a2c36;
        /* Colores del pulgar y del track */
