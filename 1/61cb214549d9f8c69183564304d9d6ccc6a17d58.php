...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('dashboar.dashboardPlanta1PorMes')); ?>" method="GET" id="filterForm">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" id="mes_inicio" name="mes_inicio"
                                value="<?php echo e(request('mes_inicio', now()->format('Y-m'))); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" id="mes_fin" name="mes_fin"
                                value="<?php echo e(request('mes_fin', now()->format('Y-m'))); ?>" required>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboardPorDia', 'titlePage' => __('Dashboard')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\dashboar\dashboardPlanta1PorMes.blade.php ENDPATH**/ ?>