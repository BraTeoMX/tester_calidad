                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if(isset($auditoriaMarcada)): ?>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaMarcada->{'talla'.$i}); ?>" readonly />
                                                            <?php else: ?>
                                                                <select name="talla<?php echo e($i); ?>" class="form-control">
                                                                    <option value="">Selecciona una talla</option>
                                                                    <?php $__currentLoopData = $auditoriaMarcadaTalla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizename): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 6; $i++): ?>
                                                        <td>
                                                            <input type="number" class="form-control texto-blanco" name="bulto<?php echo e($i); ?>"
                                                                value="<?php echo e(isset($auditoriaMarcada) ? $auditoriaMarcada->{'bulto'.$i} : ''); ?>"
                                                                <?php echo e(isset($auditoriaMarcada) ? 'readonly' : ''); ?> />
                                                        </td>
                                                        <?php endfor; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 6; $i++): ?>
                                                        <td>
                                                            <input type="number" class="form-control texto-blanco" name="total_pieza<?php echo e($i); ?>"
                                                                value="<?php echo e(isset($auditoriaMarcada) ? $auditoriaMarcada->{'total_pieza'.$i} : ''); ?>"
                                                                <?php echo e(isset($auditoriaMarcada) ? 'readonly' : ''); ?> />
                                                        </td>
                                                        <?php endfor; ?>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if(isset($auditoriaMarcada)): ?>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaMarcada->{'talla_parcial'.$i}); ?>" readonly />
                                                            <?php else: ?>
                                                                <select name="talla_parcial<?php echo e($i); ?>" class="form-control">
                                                                    <option value="">Selecciona una talla</option>
                                                                    <?php $__currentLoopData = $auditoriaMarcadaTalla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizename): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 6; $i++): ?>
                                                        <td>
                                                            <input type="number" class="form-control texto-blanco" name="bulto_parcial<?php echo e($i); ?>"
                                                                value="<?php echo e(isset($auditoriaMarcada) ? $auditoriaMarcada->{'bulto_parcial'.$i} : ''); ?>"
                                                                <?php echo e(isset($auditoriaMarcada) ? 'readonly' : ''); ?> />
                                                        </td>
                                                        <?php endfor; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php for($i = 1; $i <= 6; $i++): ?>
                                                        <td>
                                                            <input type="number"  class="form-control texto-blanco" name="total_pieza_parcial<?php echo e($i); ?>"
                                                                value="<?php echo e(isset($auditoriaMarcada) ? $auditoriaMarcada->{'total_pieza_parcial'.$i} : ''); ?>"
                                                                <?php echo e(isset($auditoriaMarcada) ? 'readonly' : ''); ?> />
                                                        </td>
                                                        <?php endfor; ?>
                                                ...
                                                <tbody>
                                                    <?php for($panel = 1; $panel <= 4; $panel++): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" name="simetria_pieza<?php echo e($panel); ?>" id="simetria_pieza<?php echo e($panel); ?>" placeholder="panel <?php echo e($panel); ?>" value="<?php echo e(isset($Lectra) ? $Lectra->{'simetria_pieza'.$panel} : ''); ?>" />
                                                            </td>
                                                            <!-- Panel X -->
                                                            <td>
                                                ...
                                                <tbody>
                                                    <?php for($panel = 1; $panel <= 4; $panel++): ?>
                                                        <tr>
                                                            <th scope="row">Panel <?php echo e($panel); ?></th>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" name="simetria_pieza<?php echo e($panel); ?>" id="simetria_pieza<?php echo e($panel); ?>" placeholder="panel <?php echo e($panel); ?>" value="<?php echo e(isset($Lectra) ? $Lectra->{'simetria_pieza'.$panel} : ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e(isset($Lectra) ? $Lectra->{'panel'.$panel.'_x1'} : ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e(isset($Lectra) ? $Lectra->{'panel'.$panel.'_x2'} : ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e(isset($Lectra) ? $Lectra->{'panel'.$panel.'_y1'} : ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e(isset($Lectra) ? $Lectra->{'panel'.$panel.'_y2'} : ''); ?>" readonly />
                                                            </td>
                                                        </tr>
                                                    <?php endfor; ?>
                                                </tbody>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Progreso Corte', 'titlePage' => __('Progreso Corte')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\auditoriaCorte\auditoriaCorte.blade.php ENDPATH**/ ?>