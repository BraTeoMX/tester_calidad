                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="week" class="form-control" id="fecha_inicio" name="fecha_inicio" value="<?php echo e($fechaInicioInput); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fecha_fin">Semana fin</label>
                                            <input type="week" class="form-control" id="fecha_fin" name="fecha_fin" value="<?php echo e($fechaFinInput); ?>" required>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startPush('js'); ?> 
    ...
    <script>
        $(document).ready(function () {
            ...
            function exportExcel(planta) {
                ...
                const form = $('<form>', {
                    method: 'POST',
                    action: '<?php echo e(route("export.semana")); ?>' // Ruta genérica
                });
    ...
    function cargarDatos() {
        ...
        $.ajax({
            url: '<?php echo e(route("dashboarComparativaModulo.semanaComparativaGeneralData")); ?>',
            data: {
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboardComparativoClientes', 'titlePage' => __('Dashboard Comparativo Clientes')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\dashboarComparativaModulo\semanaComparativaGeneral.blade.php ENDPATH**/ ?>