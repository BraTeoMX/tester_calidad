                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h2 class="card-title">
                                <a href="<?php echo e(route('dashboar.dashboardPlanta2Detalle')); ?>">Intimark Mensual General</a>
                            </h2>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table id="tablaClientes" class="table tablesorter">
                            ...
                            <tr style="background: #1d1c1c;">
                              <td>GENERAL</td>
                              <td><?php echo e(number_format($generalProcesoPlanta2, 2)); ?>%</td>
                              <td><?php echo e(number_format($generalAQLPlanta2, 2)); ?>%</td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    <div class="row"> 
        <div class="col-lg-6 col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dashboar.detalleXModuloPlanta2')); ?>" method="GET">
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\dashboar\dashboardPlanta2.blade.php ENDPATH**/ ?>