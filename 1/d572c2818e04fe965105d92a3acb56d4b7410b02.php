...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <h1 class="card-title" style="font-size: 280%;"><?php echo e(__('Terceras')); ?></h1>
            <!-- Fila de Tarjetas -->
            <div class="row">
                <!-- Tarjeta Fecha -->
                ...
                success: function(response) {
                    ...
                    response.ObtenerPlantas.forEach(function(plant) {
                        $('#dropdownSearchPlanta ul').append(
                            ...
                            <input id="checkbox-item-${plant}" type="checkbox" value="${plant}" class="planta-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            ${plant}
                        </li>`
                        );
                    });
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            response.ObtenerModulos.forEach(function(modulo) {
                                ...
                                <li class="py-1 px-2 hover:bg-gray-600 cursor-pointer">
                                    <input id="checkbox-modulo-${modulo}" type="checkbox" value="${modulo}" class="modulo-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    ${modulo}
                                </li>
                            `);
                            });
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            response.ObtenerClientes.forEach(function(cliente) {
                                ...
                                <li class="py-1 px-2 hover:bg-gray-600 cursor-pointer">
                                    <input id="checkbox-cliente-${cliente}" type="checkbox" value="${cliente}" class="cliente-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    ${cliente}
                                </li>
                            `);
                            });
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Terceras', 'titlePage' => __('Terceras')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\Segundas\Terceras.blade.php ENDPATH**/ ?>