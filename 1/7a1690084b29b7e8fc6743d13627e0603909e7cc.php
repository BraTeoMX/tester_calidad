                    ...
                    <div class="form-group">
                        ...
                        <select id="select-estilo" class="form-control">
                            ...
                            <?php $__currentLoopData = $estilos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estilo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($estilo->itemid); ?>" data-customer="<?php echo e($estilo->customername); ?>">
                                    <?php echo e($estilo->itemid); ?> - <?php echo e($estilo->customername); ?>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'GestionBusqueda', 'titlePage' => __('GestionBusqueda')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\gestion\agregarAqlProceso.blade.php ENDPATH**/ ?>