...
<?php $__env->startSection('content'); ?> 
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    document.getElementById("filterForm").addEventListener("submit", function(event) {
                        ...
                        this.action = "<?php echo e(route('dashboar.dashboardPlanta2Detalle')); ?>?fecha_inicio=" + fechaInicioValue + "&fecha_fin=" + fechaFinValue;
                    });
                });
        ...
        <div class="modal-dialog modal-fullscreen" role="document"> <!-- Cambiado a modal-fullscreen -->
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetalleLabel<?php echo e($index); ?>">Detalles para <?php echo e($cliente); ?></h5>
    ...
    <div class="modal fade" id="modalDetalleModulo<?php echo e($moduloIndex); ?>" tabindex="-1" role="dialog" aria-labelledby="modalDetalleModuloLabel<?php echo e($moduloIndex); ?>" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen" role="document"> <!-- Cambiado a modal-fullscreen -->
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetalleModuloLabel<?php echo e($moduloIndex); ?>">Detalles para Módulo: <?php echo e($modulo); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalDetalleSupervisor<?php echo e($supervisorIndex); ?>" tabindex="-1" role="dialog" aria-labelledby="modalDetalleSupervisorLabel<?php echo e($supervisorIndex); ?>" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen" role="document"> <!-- Cambiado a modal-fullscreen -->
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetalleSupervisorLabel<?php echo e($supervisorIndex); ?>">Detalles para Supervisor: <?php echo e($team_leader); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php $__currentLoopData = $clientesGrafica; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                tableIds.push('#modalClienteAQLDetalle<?php echo e($index); ?>');
                tableIds.push('#modalClienteProcesoDetalle<?php echo e($index); ?>');
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $modulosGrafica; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduloIndex => $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                tableIds.push('#modalModuloAQLDetalle<?php echo e($moduloIndex); ?>');
                tableIds.push('#modalModuloProcesoDetalle<?php echo e($moduloIndex); ?>');
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $teamLeadersGrafica; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisorIndex => $team_leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                tableIds.push('#modalSupervisorAQLDetalle<?php echo e($supervisorIndex); ?>');
                tableIds.push('#modalSupervisorProcesoDetalle<?php echo e($supervisorIndex); ?>');
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\dashboar\dashboardPlanta2Detalle.blade.php ENDPATH**/ ?>