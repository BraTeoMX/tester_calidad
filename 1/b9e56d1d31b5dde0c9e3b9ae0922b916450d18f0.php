    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            <?php if(auth()->check() && (auth()->user()->hasRole('Administrador') || auth()->user()->hasRole('Gerente de Calidad'))): ?>
                <li class="nav-item<?php echo e($pageSlug == 'dashboard' ? ' active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>">
                        <i class="tim-icons icon-chart-pie-36"></i>
                        <p><?php echo e(__('Dashboard')); ?></p>
                    </a>
                </li>
                <li class="nav-item<?php echo e($pageSlug == 'dashboardPorDia' ? ' active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('dashboar.dashboardPanta1PorDia')); ?>">
                        <i class="tim-icons icon-tap-02"></i>
                        <p><?php echo e(__('Consulta por Dia')); ?></p>
                    </a>
                </li>
                <li class="nav-item<?php echo e($pageSlug == 'dashboardPorSemanal' ? ' active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('dashboar.dashboardPlanta1PorSemana')); ?>">
                        <i class="tim-icons icon-tap-02"></i>
                        <p><?php echo e(__('Consulta por Semana')); ?></p>
                    </a>
                </li> 
                <li class="nav-item<?php echo e($pageSlug == 'dashboardComparativoClientes' ? ' active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('dashboarComparativaModulo.semanaComparativaGeneral')); ?>">
                        <i class="tim-icons icon-bag-16"></i>
                        <p><?php echo e(__('Comparativo Clientes')); ?></p>
                    </a>
                </li> 
            <?php endif; ?>
            ...
            <?php if(auth()->check() && (auth()->user()->hasRole('Administrador') || auth()->user()->hasRole('Gerente de Calidad'))): ?>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="laravelExample">
                        <ul class="nav">
                            <li class="nav-item<?php echo e($pageSlug == 'Gestion' ? ' active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(route('altaYbaja')); ?>">
                                    <i class="tim-icons icon-support-17"></i>
                                    <p><?php echo e(__('Gestión de Categorías')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item<?php echo e($pageSlug == 'GestionBusqueda' ? ' active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(route('gestion.agregarAqlProceso')); ?>">
                                    <i class="tim-icons icon-zoom-split"></i>
                                    <p><?php echo e(__('Busqueda Bulto/Estilo')); ?></p>
                                </a>
                            </li>
                            <li class="nav-item">
