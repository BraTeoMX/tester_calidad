                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?php echo e(route('auditoriaCorte.formAuditoriaMarcadaV2')); ?>"> 
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="idAuditoriaMarcada" value="<?php echo e($auditoriaMarcada->encabezado_id); ?>">
                                            ...
                                            <table id="tablaDinamica" class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <th>
                                                                <select name="tallas[<?php echo e($i); ?>]" class="form-control">
                                                                    ...
                                                                    <?php $__currentLoopData = $auditoriaMarcadaTalla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizename): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($sizename); ?>" <?php echo e($tallas[$i] == $sizename ? 'selected' : ''); ?>><?php echo e($sizename); ?></option>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td># Bultos</td> 
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <td><input type="number" class="form-control" name="bultos[<?php echo e($i); ?>]" value="<?php echo e($bultos[$i]); ?>" /></td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                    <tr>
                                                        <td>Total Piezas</td>
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <td><input type="number" class="form-control" name="total_piezas[<?php echo e($i); ?>]" value="<?php echo e($totalPiezas[$i]); ?>" /></td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="tablaParcialesDinamica" class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Tallas</th>
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <th>
                                                                <select name="tallas_parciales[<?php echo e($i); ?>]" class="form-control">
                                                                    <option value="">Selecciona una talla</option>
                                                                    <?php $__currentLoopData = $auditoriaMarcadaTalla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizename): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($sizename); ?>" <?php echo e($tallasParciales[$i] == $sizename ? 'selected' : ''); ?>><?php echo e($sizename); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </th>
                                                        <?php endfor; ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <td>
                                                                <input type="number" class="form-control" name="bultos_parciales[<?php echo e($i); ?>]" value="1" readonly />
                                                            </td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                    <tr>
                                                        <td>Total Piezas</td>
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <td><input type="number" class="form-control" name="total_piezas_parciales[<?php echo e($i); ?>]" value="<?php echo e($totalPiezasParciales[$i]); ?>" /></td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div>
                                        ...
                                        <?php if($mostrarFinalizarMarcada == True): ?>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            let columnCount = <?php echo e($numColumns); ?>;
                                            let columnParcialCount = <?php echo e($numColumnsParciales); ?>;
                                            const tallas = <?php echo json_encode($auditoriaMarcadaTalla, 15, 512) ?>;
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <th>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($tallas[$i] ?? ''); ?>" readonly />
                                                            </th>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <td>
                                                                <input type="number" class="form-control texto-blanco" value="<?php echo e($bultos[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumns; $i++): ?>
                                                            <td>
                                                                <input type="number" class="form-control texto-blanco" value="<?php echo e($totalPiezas[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <th>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($tallasParciales[$i] ?? ''); ?>" readonly />
                                                            </th>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <td>
                                                                <input type="number" class="form-control texto-blanco" value="<?php echo e($bultosParciales[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <?php for($i = 0; $i < $numColumnsParciales; $i++): ?>
                                                            <td>
                                                                <input type="number" class="form-control texto-blanco" value="<?php echo e($totalPiezasParciales[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                        <?php endfor; ?>
                                                    </tr>
                                                </tbody>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <form method="POST"
                                    action="<?php echo e(route('auditoriaCorte.formAuditoriaTendidoV2')); ?>"> 
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="idAuditoriaTendido" value="<?php echo e($auditoriaTendido->encabezado_id); ?>">
                                ...
                                <?php elseif($encabezadoAuditoriaCorte && ($encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaMarcada' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaTendido' || $encabezadoAuditoriaCorte->estatus == 'estatusLectra' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaBulto' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaFinal' || $encabezadoAuditoriaCorte->estatus == 'fin')): ?>
                                    <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php if(isset($auditoriaTendido)): ?>
                                                        <?php $__currentLoopData = explode(',', trim($auditoriaTendido->nombre)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <input type="text" class="form-control mb-2  texto-blanco" value="<?php echo e($nombre); ?>" readonly />
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <?php if(isset($auditoriaTendido)): ?>
                                                    <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->mesa); ?>" readonly />
                                                <?php else: ?>
                                                    <select name="mesa" id="mesa" class="form-control" title="Por favor, selecciona una opción" required>
                                                        <option value="">Selecciona una opción</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center" style="margin-right: -5px;">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <?php if(isset($auditoriaTendido)): ?>
                                                        <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->informacion_trazo); ?>" readonly />
                                                    <?php else: ?>
                                                        <select name="informacion_trazo" id="informacion_trazo" class="form-control" title="Por favor, selecciona una opción">
                                                            <option value="">Selecciona una opción</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center" style="margin-right: -5px;">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <?php if(isset($auditoriaTendido)): ?>
                                                        <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->material_relajado); ?>" readonly />
                                                    <?php else: ?>
                                                        <select name="material_relajado" id="material_relajado" class="form-control"
                                                            title="Por favor, selecciona una opción">
                                                            <option value="">Selecciona una opción</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center" style="margin-right: -5px;">
                                                <div class="form-check form-check-inline">
                                                    <?php if(isset($auditoriaTendido)): ?>
                                                        <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->alineacion_tendido); ?>" readonly />
                                                    <?php else: ?>
                                                        <select name="alineacion_tendido" id="alineacion_tendido" class="form-control" title="Por favor, selecciona una opción">
                                                            <option value="">Selecciona una opción</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center" style="margin-right: -5px;">
                                                <div class="form-check form-check-inline">
                                                    <?php if(isset($auditoriaTendido)): ?>
                                                        <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->arruga_tendido); ?>" readonly />
                                                    <?php else: ?>
                                                        <select name="arruga_tendido" id="arruga_tendido" class="form-control" title="Por favor, selecciona una opción"> 
                                                            <option value="">Selecciona una opción</option>
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center" style="margin-right: -5px;">
                                                <?php if(isset($auditoriaTendido)): ?>
                                                    <?php $__currentLoopData = explode(',', trim($auditoriaTendido->defecto_material)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <input type="text" class="form-control mb-2  texto-blanco" value="<?php echo e($defecto); ?>" readonly />
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                    <select name="defecto_material[]" id="defecto_material" class="form-control" multiple>
                                                        <option value="">Selecciona una opción</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <?php if(isset($auditoriaTendido)): ?>
                                                    <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->bio_tension); ?>" readonly />
                                                <?php else: ?>
                                                    <select class="form-control me-2" name="bio_tension" id="bio_tension" required>
                                                        <option value="">Selecciona una opcion</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <?php if(isset($auditoriaTendido)): ?>
                                                    <input type="text" class="form-control texto-blanco" value="<?php echo e($auditoriaTendido->accion_correctiva); ?>" readonly />
                                                <?php else: ?>
                                                    <select name="accion_correctiva" id="accion_correctiva" class="form-control me-2" required>
                                                        <option value="">Selecciona una opción</option>
                                                        <?php $__currentLoopData = $CategoriaAccionCorrectiva; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST"
                                    action="<?php echo e(route('auditoriaCorte.formLectraV2')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($encabezadoAuditoriaCorte->id); ?>">
                                    <input type="hidden" name="idLectra" value="<?php echo e($Lectra->encabezado_id); ?>">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table" id="tablaPaneles">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php for($i = 0; $i < $numFilas; $i++): ?>
                                                        <tr>
                                                            <th scope="row">Panel <?php echo e($i + 1); ?></th>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" name="simetria_piezas[]" placeholder="Panel <?php echo e($i + 1); ?>" value="<?php echo e($simetria_piezas[$i] ?? ''); ?>" />
                                                            </td>
                                                            <!-- Panel X -->
                                                            <td>
                                                                <select name="panel_x1[]" class="form-control" title="Por favor, selecciona una opción">
                                                                    ...
                                                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($option); ?>" <?php echo e((isset($panel_x1[$i]) && $panel_x1[$i] == $option) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select name="panel_x2[]" class="form-control" title="Por favor, selecciona una opción">
                                                                    ...
                                                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($option); ?>" <?php echo e((isset($panel_x2[$i]) && $panel_x2[$i] == $option) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </td>
                                                            <!-- Panel Y -->
                                                            <td>
                                                                <select name="panel_y1[]" class="form-control" title="Por favor, selecciona una opción">
                                                                    <option value="">Rango Inicial</option>
                                                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($option); ?>" <?php echo e((isset($panel_y1[$i]) && $panel_y1[$i] == $option) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select name="panel_y2[]" class="form-control" title="Por favor, selecciona una opción">
                                                                    <option value="">Rango Final</option>
                                                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($option); ?>" <?php echo e((isset($panel_y2[$i]) && $panel_y2[$i] == $option) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                            ...
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    ...
                                                    let panelCount = <?php echo e($numFilas); ?>;
                                ...
                                <?php elseif($encabezadoAuditoriaCorte && ($encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaMarcada' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaTendido' || $encabezadoAuditoriaCorte->estatus == 'estatusLectra' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaBulto' || $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaFinal' || $encabezadoAuditoriaCorte->estatus == 'fin')): ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <?php if(isset($Lectra)): ?>
                                                    <input type="text" class="form-control texto-blanco" value="<?php echo e($Lectra->mesa); ?>" readonly />
                                                <?php else: ?>
                                                    <select name="mesa" id="mesa" class="form-control" title="Por favor, selecciona una opción">
                                                        <option value="">Selecciona una opción</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="auditor" class="col-sm-6 col-form-label">AUDITOR</label>
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <input type="text" class="form-control me-2 texto-blanco" name="auditor" id="auditor" value="<?php echo e($auditorDato); ?>" readonly required />
                                                <input type="hidden" name="auditor" value="<?php echo e($auditorDato); ?>">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php for($i = 0; $i < $numFilas; $i++): ?>
                                                        <tr>
                                                            <th scope="row">Panel <?php echo e($i + 1); ?></th>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($simetria_piezas[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                            <!-- Panel X -->
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($panel_x1[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($panel_x2[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                            <!-- Panel Y -->
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($panel_y1[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control texto-blanco" value="<?php echo e($panel_y2[$i] ?? ''); ?>" readonly />
                                                            </td>
                                                        </tr>
                                                    <?php endfor; ?>
                                                </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <?php if(isset($Lectra)): ?>
                                                    <input type="text" class="form-control texto-blanco" value="<?php echo e($Lectra->nivel_aql); ?>" readonly />
                                                <?php else: ?>
                                                    <select class="form-control" name="nivel_aql" id="nivel_aql">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <form method="POST"
                                    action="<?php echo e(route('auditoriaCorte.formAuditoriaBultoV2')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($encabezadoAuditoriaCorte->id); ?>">
                                    <input type="hidden" name="idBulto" value="<?php echo e($auditoriaBulto->encabezado_id); ?>"> 
                                            ...
                                            <div class="col-sm-12 d-flex align-items-center">
                                                <?php if(isset($auditoriaBulto)): ?>
                                                    <?php $__currentLoopData = explode(',', $auditoriaBulto->nombre); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <input type="text" class="form-control me-2 mb-2 texto-blanco" value="<?php echo e(trim($nombre)); ?>" readonly />
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <?php if($encabezadoAuditoriaCorte && $encabezadoAuditoriaCorte->estatus == 'estatusAuditoriaFinal'): ?>
                                    <form method="POST"
                                        action="<?php echo e(route('auditoriaCorte.formAuditoriaFinalV2')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="id" value="<?php echo e($encabezadoAuditoriaCorte->id); ?>">
                                        <input type="hidden" name="idAuditoriaFinal" value="<?php echo e($auditoriaFinal->encabezado_id); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#guardarNuevoDefecto').click(function() {
                ...
                if (nuevoDefecto) {
                    $.ajax({
                        url: '<?php echo e(route("auditoriaCorte.agregarDefecto")); ?>',
                        method: 'POST',
                        data: {
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Progreso Corte', 'titlePage' => __('Progreso Corte')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\auditoriaCorte\auditoriaCorteV2.blade.php ENDPATH**/ ?>