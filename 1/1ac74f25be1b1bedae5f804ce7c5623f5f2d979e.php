            ...
            "z-index": "9999"
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        _token: '<?php echo e(csrf_token()); ?>' // Token CSRF para la seguridad
                    },
                    dataType: 'json',
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Etiquetas', 'titlePage' => __('Etiquetas')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\formulariosCalidad\auditoriaEtiquetas.blade.php ENDPATH**/ ?>