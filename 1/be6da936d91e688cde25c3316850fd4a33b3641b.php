    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <hr>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('auditoriaAQL.formAltaProcesoAQL_v2')); ?>"> 
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'AQL', 'titlePage' => __('AQL')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\auditoriaAQL\altaAQL_v2.blade.php ENDPATH**/ ?>