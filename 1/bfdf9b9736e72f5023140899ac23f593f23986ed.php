                                                    ...
                                                    <?php $__currentLoopData = $EncabezadoAuditoriaCorte->unique('orden_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $encabezadoCorte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="card proceso-card" data-proceso="<?php echo e($encabezadoCorte->orden_id); ?>">
                                                            ...
                                                            <div id="collapse<?php echo e($encabezadoCorte->orden_id); ?>" class="collapse"
                                                                ...
                                                                <div class="card-body">
                                                                    <div>
                                                                        <form method="POST" action="<?php echo e(route('auditoriaCorte.agregarEventoCorteV2')); ?>">
                                                                            <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody>
                                                                            <?php $__currentLoopData = $EncabezadoAuditoriaCorteFiltro->where('orden_id', $encabezadoCorte->orden_id)->where('estatus', '!=', 'fin'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $encabezado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr>
                                                                                    <td><a href="<?php echo e(route('auditoriaCorte.auditoriaCorteV2', ['id' => $encabezado->id, 'orden' => $encabezado->orden_id])); ?>"
        ...
        <script>
            $(document).ready(function() {
                $('#searchInput').on('input', function() {
                    var query = $(this).val();
                    $.ajax({
                        url: "<?php echo e(route('auditoriaCorte.inicioAuditoriaCorte')); ?>",
                        type: "GET",
                        data: {
                            'search': query
                        },
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'Progreso Corte', 'titlePage' => __('Progreso Corte')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.2\htdocs\calidad2\resources\views\auditoriaCorte\inicioAuditoriaCorte.blade.php ENDPATH**/ ?>