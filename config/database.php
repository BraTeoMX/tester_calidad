...
return [
    ...
    'connections' => [
        ...
        'avances' => [
            'driver' => 'mysql',
            'host' => env('DB_AVANCES_HOST', '127.0.0.1'),
            'port' => env('DB_AVANCES_PORT', '3306'),
            'database' => env('DB_AVANCES_DATABASE', 'forge'),
            'username' => env('DB_AVANCES_USERNAME', 'forge'),
            'password' => env('DB_AVANCES_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
