                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h2 class="card-title"><a href="<?php echo e(route('dashboar.dashboardPlanta1Detalle')); ?>">Intimark Mensual General</a></h2>
                        </div>
                        <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboard', 'titlePage' => __('Dashboard')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\tester_calidad\resources\views/dashboar/dashboardPlanta1.blade.php ENDPATH**/ ?>