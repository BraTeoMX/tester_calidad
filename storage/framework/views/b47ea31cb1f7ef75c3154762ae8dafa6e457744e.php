        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header card-header-primary">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title"><?php echo e(__('Inspeccion Estampado Despues del Horno.')); ?></h3>
                        </div>
            ...
            <div class="container-fluid">
                <div class="card" style="width: auto;">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title"><?php echo e(__('Inspección en  Bultos.')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <!-- Tabla de resultados -->
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'InspeccionEstampado', 'titlePage' => __('Inspeccion Estampado Despues del Horno')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp1\htdocs\tester_calidad\resources\views\ScreenPlanta2\InsEstamHorno.blade.php ENDPATH**/ ?>