...
<div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header card-header-primary">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title"><?php echo e(__('Screen Print.')); ?></h3>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h3 class="card-title"><?php echo e(__('Defectos detectados.')); ?></h3>
                    </div>
                    <br>
                    <div class="row">
                                ...
                                <div class="card-header card-header-danger card-header-icon">
                                    <div class="card-icon">
                                        <i><img style="width:50px" class="negative-image"
                                                src="<?php echo e(asset('material')); ?>/img/breaking_news_alt_1.svg"></i>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mx-auto">
                            <div class="card card-stats">
                                <div class="card-header card-header-warning card-header-icon">
                                    <div class="card-icon">
                                        <i><img style="width:50px" class="negative-image"
                                                src="<?php echo e(asset('material')); ?>/img/swap_driving_apps_wheel.svg"></i>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="tablaDinamico">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h3 class="card-title"><?php echo e(__('Control de Horno.')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    success: function(data) {
                        try {
                            ...
                            $.each(data, function(index, item) {
                                ...
                                $('#tablaDinamico tbody').append(row);
        ...
        <script>
            ...
            $('#insertarFila').on('click', function() {
                ...
                lastRegisteredId++;
                var auditor = '<?php echo e(Auth::user()->name); ?>';
                ...
                var newRow = '<tr>' +
                    ...
                    '</tr>';
                $('#tablaDinamico tbody').append(newRow);
        ...
        <script>
            $(document).ready(function() {
                $('#Finalizar').click(function() {
                    ...
                    $('#tablaDinamico tbody tr').each(function() {
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>', // Añade el token CSRF aquí
                                status: 'Finalizado'
                            },
                            success: function(response) {
                                console.log(
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'ScreenPrint', 'titlePage' => __('Screen Print')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tester_calidad\resources\views/ScreenPlanta2/ScreenPrint.blade.php ENDPATH**/ ?>