            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <div class="input-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?>">
                        ...
                        <input type="text" name="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Email or Employee Number')); ?>">
...
<?php echo $__env->make('layouts.app', ['class' => 'login-page', 'page' => __('Sistema de Calidad'), 'contentClass' => 'login-page'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/proyectos-laravel/calidad_testeoxD/tester_calidad/resources/views/auth/login.blade.php ENDPATH**/ ?>