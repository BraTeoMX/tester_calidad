...
class DashboardPlanta2DetalleController extends Controller
{
    ...
    private function obtenerDatosModulosPorRangoFechas($fechaInicio, $fechaFin, $planta = 'Intimark2')
    {
    ...
    private function obtenerDatosTeamLeaderPorRangoFechas($fechaInicio, $fechaFin, $planta = 'Intimark2')
    {
