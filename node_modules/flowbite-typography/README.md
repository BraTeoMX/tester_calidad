...
_Disclaimer: this plugin is a fork from the official [Tailwind CSS Typography Plugin](https://tailwindcss.com/docs/typography-plugin) with different styles and settings_
...
2. Require Flowbite Typography as a plugin inside the `tailwind.config.js` file:
